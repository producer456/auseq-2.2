...
/// AstroLab visual language (v2) — matte snow-white surfaces, blonde-wood cheeks,
/// teal/mint accents, a circular nav-wheel screen, macro knobs with LED rings.
/// "Dark mode" only blackens the inside of the arranger; the chrome stays light.
enum Theme {
